...
test('return the string "success"', function (t) {
	Shot.inject(wordkat.handler, {method: 'GET', url: "/worddef/cat"}, function (res) {
		t.equal(!!res.payload, true, "Congrats");
	});
    t.end();
});
test('return the string "success"', function (t) {
	Shot.inject(wordkat.handler, {method: 'GET', url: "/js/ac.js"}, function (res) {
		t.equal(!!res.payload, true, "Congrats");
	});
    t.end();
});
test('return the string "success"', function (t) {
	Shot.inject(wordkat.handler, {method: 'GET', url: "/js/wn.js"}, function (res) {
		t.equal(!!res.payload, true, "Congrats");
	});
    t.end();
});
test('return the string "success"', function (t) {
	Shot.inject(wordkat.handler, {method: 'GET', url: "/wordnik.js"}, function (res) {
		t.equal(!!res.payload, true, "Congrats");
	});
    t.end();
});
test('return the string "success"', function (t) {
	Shot.inject(wordkat.handler, {method: 'GET', url: "/autocomplete.js"}, function (res) {
		t.equal(!!res.payload, true, "Congrats");
	});
    t.end();
});
test('return the string "success"', function (t) {
	Shot.inject(wordkat.handler, {method: 'GET', url: "/frontendtests.js"}, function (res) {
		t.equal(!!res.payload, true, "Congrats");
	});
    t.end();
});
